...
public class PriceUpdateDB {
	
	private Connection conn = null;
	private Properties prop = null;

	public PriceUpdateDB(Connection conn) {
		this.conn = conn;
		prop = new Properties();
		FileReader fr;
		try {
	...
	public void delete() throws SQLException {
		...
		String sql = prop.getProperty("Delete_AllPRICE");
	...
	public void allPrice(List<Price> list) throws ClassNotFoundException, IOException {
		...
		try {
			...
			for(Price price : list) {
				...
				PreparedStatement pstmt = null;
				String sql = prop.getProperty("PriceDao_AllPRICE");
