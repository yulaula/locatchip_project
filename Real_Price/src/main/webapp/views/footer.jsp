...
<!-- Footer-->
   <footer class="footer bg-yellow pt-5">
        <div class="container pt-2 pb-3">
            <div class="row">
                <div class="col-md-4 text-center text-md-start mb-4">
                    ...
                    <div class="widget mt-4 text-md-nowrap text-center text-md-start"><a class="btn-social bs-dark bs-twitter me-2 mb-2" href="#"><i class="ci-twitter"></i></a><a class="btn-social bs-dark bs-facebook me-2 mb-2" href="#"><i class="ci-facebook"></i></a><a class="btn-social bs-dark bs-instagram me-2 mb-2"
                            href="#"><i class="ci-instagram"></i></a></div>
                </div>
                ...
                <div class="col-md-4 d-none d-md-block text-center text-md-start mb-4">
                    <div class="widget widget-links widget-light pb-2">
                        <h3 class="widget-title text-dark">Information</h3>
                        <ul class="widget-list">
                            <li class="widget-list-item">상호명 및 호스팅 서비스 제공 : 로켓칩
                                <br> 대표이사 : 홍길동
                                <br> 06234) 서울특별시 강남구 테헤란로 130
                                <br> 사업자 등록번호 : 000-00-00000
                                <br> 통신판매업신고 : 2022-서울강남-0000
                                <br></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4 d-none d-md-block text-center text-md-start mb-4">
                    <div class="widget widget-links widget-light pb-2">
                        <h3 class="widget-title text-dark">고객센터</h3>
                        <ul class="widget-list">
                            <li class="widget-list-item">04540) 서울특별시 중구 남대문로 120
                                <br>Tel : 1566-0000 (평일 09:00 ~ 18:00)
                                <br>VIP전용 Tel : 1522-0000(365일 09:00 ~ 18:00)
                                <br>Fax : 02-000-0000
                                <br>Mail : help@locationchip.com</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- Second row-->
        <div class="pt-5 bg-yellow">
            <div class="container">
                <hr class="hr-light mb-3">
                <div class="d-md-flex justify-content-between pt-4">
                    <div class="pb-4 fs-xs text-dark opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-dark" href="index.html" target="_blank" rel="noopener">LocationChip</a></div>
    ...
    <div class="handheld-toolbar">
        <div class="d-table table-layout-fixed w-100"><a class="d-table-cell handheld-toolbar-item" href="dashboard-favorites.html"><span class="handheld-toolbar-icon"><i class="ci-heart"></i></span><span class="handheld-toolbar-label">Favorites</span></a><a class="d-table-cell handheld-toolbar-item"
                ...
                href="marketplace-cart.html"><span class="handheld-toolbar-icon"><i class="ci-cart"></i><span class="badge bg-primary rounded-pill ms-1">3</span></span><span class="handheld-toolbar-label">$56.00</span></a></div>
    </div>
