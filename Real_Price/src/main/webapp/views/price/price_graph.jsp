...
<!-- Sidebar menu-->
<aside
	class="offcanvas offcanvas-expand w-100 border-end zindex-lg-5 pt-lg-5"
	id="sideNav" style="max-width: 20rem;">
	...
	<ul class="nav nav-tabs nav-justified mt-4 mt-lg-5 mb-0" role="tablist"
		...
		<li class="nav-item"><a class="nav-link fw-medium active"
			href="#categories" data-bs-toggle="tab" role="tab">상품 목록</a></li>
		<li class="nav-item d-lg-none"><a class="nav-link fs-sm" href="#"
			data-bs-dismiss="offcanvas" role="tab"><i
				class="ci-close fs-xs me-2"></i>Close</a></li>
	</ul>
					...
					<div class="accordion" id="shop-categories">
						...
						<div class="accordion-item border-bottom">
							<h3 class="accordion-header px-grid-gutter">
								<a class="nav-link-style d-block fs-md fw-normal py-3"
									href="price-statistics.html"><span
									class="d-flex align-items-center"><i
										class="ci-corn fs-lg text-danger mt-n1 me-2"></i>머거본 꿀땅콩(135g)</span></a>
							</h3>
						</div>
			...
			<nav aria-label="breadcrumb">
				<ol
					...
					<li class="breadcrumb-item text-nowrap"><a
						href="marketplace-category.html">Market</a></li>
					<li class="breadcrumb-item text-nowrap active" aria-current="page">Single
						Item</li>
				</ol>
			</nav>
		</div>
				...
				<div class="pt-3 px-4 pe-lg-0 ps-xl-5">
					...
					<div class="gallery">
						<a class="gallery-item rounded-3 mb-grid-gutter"
							href="2_img/머거본꿀땅콩.gif"
							data-sub-html="&lt;h6 class=&quot;fs-sm text-light&quot;&gt;확대하기&lt;/h6&gt;"><img
							src="2_img/머거본꿀땅콩.gif" alt="Gallery preview"><span
							class="gallery-item-caption">확대하기</span></a>
						<div class="row"></div>
					</div>
					<!-- Wishlist + Sharing-->
					<div
						...
						<div class="py-2">
							<i class="ci-share-alt fs-lg align-middle text-muted me-2"></i><a
								class="btn-social bs-outline bs-facebook bs-sm ms-2" href="#"><i
								class="ci-facebook"></i></a> <a
								class="btn-social bs-outline bs-twitter bs-sm ms-2" href="#"><i
								class="ci-twitter"></i></a><a
								class="btn-social bs-outline bs-instagram bs-sm ms-2" href="#"><i
									...
									<div class="d-flex flex-wrap justify-content-center fs-ms">
										<div class="border rounded py-1 px-2 me-2 mb-2">
											<div class="d-inline-block align-middle me-1"
												style="width: .75rem; height: .75rem; background-color: #4e54c8;"></div>
											<span class="d-inline-block align-middle">Company 1</span>
										</div>
									</div>
									<div class="ct-chart ct-perfect-fourth"
										data-line-chart='{"labels": [["W1", "W2", "W3", "W4", "W5", "W6", "W7", "W8", "W9"]], 
                                                "series": [[12, 9, 7, 8, 6, 4, 3, 2, 0]]}'
										data-options='{"axisY": {"onlyInteger": true}}'
										data-series-color='{"colors": [["#4e54c8"]]}'></div>
								</div>
							</div>
						</div>
					</div>
