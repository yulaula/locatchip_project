        ...
        <div class="page-title-overlap bg-purple pt-4">
            <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
                ...
                <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
                    <h1 class="h3 text-light mb-0">주문 완료</h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <section class="col-lg-8">
                    ...
                    <div class="d-none d-lg-flex pt-4">
                        <div class="w-50 pe-3"><a class="btn btn-secondary d-block w-100" href="checkout-details.html"><i class="ci-arrow-left mt-sm-0 me-1"></i><span class="d-none d-sm-inline">결제정보</span><span class="d-inline d-sm-none"></span></a></div>
                        <div class="w-50 ps-2"><a class="btn btn-primary d-block w-100" href="checkout-complete.html"><span class="d-none d-sm-inline">결제완료</span><span class="d-inline d-sm-none"></span><i class="ci-arrow-right mt-sm-0 ms-1"></i></a></div>
                    </div>
                </section>
                <!-- Sidebar-->
                    ...
                    <div class="bg-white rounded-3 shadow-lg p-4 ms-lg-auto">
                        <div class="py-2 px-xl-2">
                            ...
                            <ul class="list-unstyled fs-sm pb-2 border-bottom">
                                <li class="d-flex justify-content-between align-items-center"><span class="me-2">소계:</span><span class="text-end">$265.<small>00</small></span></li>
                                <li class="d-flex justify-content-between align-items-center"><span class="me-2">수수료:</span><span class="text-end">$9.<small>50</small></span></li>
                            </ul>
