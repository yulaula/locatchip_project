...
<!-- Page Title-->
        <div class="bg-accent pt-4 pb-4">
            ...
            <select class="form-select form-select-sm me-2 mb-5" style="width: 10%;  display: inline;">
                <option>전체</option>
                <option>강남구</option>
                <option>송파구</option>
                <option>광진구</option>
            ...
            <div class="bg-light shadow-lg rounded-3 mt-n5 mb-4">
                <div class="d-flex align-items-center ps-2">
                    ...
                    <div class="input-group"><i class="ci-search position-absolute top-50 start-0 translate-middle-y fs-md ms-3"></i>
                        <input class="form-control border-0 shadow-none" type="text" placeholder="점포를 입력해주세요.">
                    </div>
                    <!-- Sort-->
                ...
                <div class="col-lg-6 px-4 px-xl-5 py-5 border-top">
                    ...
                    <div class="table-responsive fs-md mb-4">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-3 text-center pt-4-1"><a class="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">신세계백화점 강남점</a></td>
                                    <td class="py-3 text-center">서울 서초구 반포동 19-3<br>02-1588-1234</td>
                                </tr>
                                <tr>
                                    <td class="py-3 text-center pt-4-1"><a class="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">신세계백화점 강남점</a></td>
                                    <td class="py-3 text-center">서울 서초구 반포동 19-3<br>02-1588-1234</td>
